...
function printout () {
	echo ('rk.header ("Probabilidad acumulada F de Fisher F(' + df1 + ',' + df2 + ')", list ("Degrees of freedom del numerador" = "' + df1 + '", "Degrees of freedom del denominador" = "' + df2 + '", "Cola de acumulaci&oacute;n" = ');
